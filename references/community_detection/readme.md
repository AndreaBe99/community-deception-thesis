...
A collection of community detection papers with implementations, from [Awesome Community Detection](https://github.com/zhanghuijun-hello/community-detection-code/blob/master/README.md).
...
- [Community Detection](#community-detection)
  ...
  - [Label Propagation, Percolation and Random Walks](#label-propagation-percolation-and-random-walks)
  - [Tensor Decomposition](#tensor-decomposition)
  - [Spectral Methods](#spectral-methods)
  - [Temporal Methods](#temporal-methods)
  - [Cyclic Patterns](#cyclic-patterns)
  - [Centrality and Cuts](#centrality-and-cuts)
  - [Physics Inspired](#physics-inspired)
  - [Others](#others)

## Deep Learning

- **Community Detection via Graph Convolutional Neural Network (GCN)**
  - [[Python Reference]](https://github.com/yl495/Community-Detection)

- **UCoDe: Unified Community Detection with Graph Convolutional Networks**
  - Atefeh Moradan, Davide Mottin, Andrew Draganov, Andrew Draganov
  - [[Paper]](https://arxiv.org/pdf/2112.14822.pdf)
  - [[Python Reference]](https://github.com/AU-DIS/UCODE)

- **Overlapping Community Detection with Graph Neural Networks**
  - Oleksandr Shchur, Stephan Günnemann
  - [[Paper]](https://arxiv.org/pdf/1909.12201.pdf)
...
- **Community-Centric Graph Convolutional Network for Unsupervised Community Detection**
  ...
  - [[Paper]](https://www.ijcai.org/Proceedings/2020/0486.pdf)
  - [[Python Reference]](https://github.com/Monti03/GUCD)
